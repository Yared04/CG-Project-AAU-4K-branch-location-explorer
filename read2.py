...
chibi_indices, chibi_buffer = ObjLoader.load_model("oe.obj")
monkey_indices, monkey_buffer = ObjLoader.load_model("fifth.obj")
...
load_texture("mus.png", textures[0])
load_texture("mus.png", textures[1])
...
projection = pyrr.matrix44.create_perspective_projection_matrix(45, 1280 / 720, 1, 1000)
chibi_pos = pyrr.matrix44.create_from_translation(pyrr.Vector3([120, 5, 0]))
monkey_pos = pyrr.matrix44.create_from_translation(pyrr.Vector3([-130, 0, 500]))

# eye, target, up
view = pyrr.matrix44.create_look_at(pyrr.Vector3([0, 70, 1000]), pyrr.Vector3([0, 0, 0]), pyrr.Vector3([0, 1, 0]))
...
while not glfw.window_should_close(window):
    ...
    rot_y = pyrr.Matrix44.from_y_rotation(-0.8 * glfw.get_time())
    model2 = pyrr.matrix44.multiply(rot_y, monkey_pos)
